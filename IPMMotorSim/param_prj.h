...
#define MOTOR_PARAMETERS_FOC \
    ...
    PARAM_ENTRY(CAT_MOTOR,   fwki,        "",        0,      100000, 80,     141 ) \
    PARAM_ENTRY(CAT_MOTOR,   vlimkp,      "",        0,      1000,   3,      142 ) \
    PARAM_ENTRY(CAT_MOTOR,   vlimki,      "",        0,      10000,  10,     143 ) \
